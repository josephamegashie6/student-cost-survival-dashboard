...
Student Financial Intelligence Dashboard v3 Pass 2
"""
import io
...
def generate_admit_comparison_pdf(saved: List[Tuple]) -> bytes:
    ...
    story.append(Paragraph("Student Financial Intelligence Dashboard · Decision Intelligence Edition", subtitle_style))
    ...
    story.append(Paragraph(
        "This memo was generated by the Student Financial Intelligence Dashboard. "
        "All figures are based on user-entered data and benchmark estimates. "
        "This is not financial advice. Verify all costs with your institution and local housing market.",
        small_style
    ))
